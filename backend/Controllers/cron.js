...
const UserModel  = require("../model/DrugsSchema")
const nodemailer = require("nodemailer");
const { differenceInCalendarMonths } = require("date-fns");
console.log("Activewai");
            ...
            const mail_option = {
             ...
             <ul><h2> ${
               ...
               expiredDrugs.map((value) => {
                ...
                const endDate = new Date(truncatedDate);
                const date = new Date()
                console.log(value.DrugName + " "  + "expires in" + " " + differenceInCalendarMonths(endDate,date) + " " + "Month(s)" );
                return (value.DrugName + " "  + "expires in" + " " + differenceInCalendarMonths(endDate,date) + " " + "Month(s)")
               })
               }  </h2></ul>`
            }
